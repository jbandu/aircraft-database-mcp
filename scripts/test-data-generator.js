...
export class TestDataGenerator {
    ...
    async generateTestAircraft() {
        ...
        for (const airline of airlines.rows) {
            ...
            for (let i = 0; i < aircraftCount; i++) {
                ...
                const prefix = registrationPrefixes[Math.floor(Math.random() * registrationPrefixes.length)];
        ...
        `;
            ...
            logger.info(`Created ${aircraftCount} test aircraft for ${airline.iata_code}`);
        }
     ...
     */
    generateSeatConfiguration(model) {
        const configs = {
