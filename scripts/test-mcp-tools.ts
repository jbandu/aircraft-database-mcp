...
class TestSuite {
   ...
   */
  private async testGetAirlineFleet(): Promise<void> {
    ...
    await this.runTest('get-airline-fleet: Missing airline_code', async () => {
      const result = await handleGetAirlineFleet({} as any);
   ...
   */
  private async testGetAircraftDetails(): Promise<void> {
    ...
    await this.runTest('get-aircraft-details: Missing registration', async () => {
      const result = await handleGetAircraftDetails({} as any);
   ...
   */
  private async testSearchAircraft(): Promise<void> {
   ...
   */
  private async testGetFleetStatistics(): Promise<void> {
   ...
   */
  private async testTriggerFleetUpdate(): Promise<void> {
   ...
   */
  private async testGetAircraftTypeSpecs(): Promise<void> {
   ...
   */
  private async testGetFleetAvailability(): Promise<void> {
  ...
  private async runErrorScenarioTests(): Promise<void> {
    ...
    await this.runTest('Error: Null values', async () => {
      const result = await handleGetAirlineFleet({ airline_code: null as any });
    ...
    await this.runTest('Error: Wrong data type', async () => {
      const result = await handleGetAirlineFleet({ airline_code: 123 as any });
  ...
  private async benchmark(
    ...
    console.log(
      `  ${status} ${name}: avg=${avg.toFixed(1)}ms, min=${min}ms, max=${max}ms, target=${targetMs}ms [${result}]`
    );
